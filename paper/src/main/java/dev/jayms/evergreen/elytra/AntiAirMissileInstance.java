...
import dev.jayms.evergreen.utils.ParticleUtil;
    ...
    public boolean progress() {
        switch (state) {
            ...
            case EXPLODING:
                ...
                this.loc.getWorld().spawnParticle(Particle.EXPLOSION_LARGE, this.loc, (int) (3 * damageRadius * damageRadius), damageRadius / 2, damageRadius / 2, damageRadius / 2, 0, null, true);
                this.loc.getWorld().spawnParticle(Particle.EXPLOSION_NORMAL, this.loc, (int) (3 * damageRadius * damageRadius), damageRadius, damageRadius, damageRadius, 0, null, true);
                ...
                this.loc.getWorld().spawnParticle(Particle.SMOKE_NORMAL, this.loc, (int) (10 * damageRadius * damageRadius), damageRadius, damageRadius, damageRadius, 0, null, true);
                this.loc.getWorld().spawnParticle(Particle.FLAME, this.loc, (int) (10 * damageRadius * damageRadius), damageRadius, damageRadius, damageRadius, 0, null, true);
...
//                    shooter.sendMessage("Damage: " + damage);

                    livingEntity.damage(antiAirMissile.getDamage(), shooter);

                    if (livingEntity.isGliding()) {
                        ElytraListener.hitDown(livingEntity);
                    }
                }
                return true;
            default:
